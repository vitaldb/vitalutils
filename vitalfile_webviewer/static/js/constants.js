/**
 * constants.js
 * Constants for the VitalFile viewer
 */
...
const CONSTANTS = {
    ...
    PARAM_LAYOUTS: {
        'ONE': [{ name: { baseline: 'top', x: 5, y: 5 }, value: { fontsize: 40, align: 'right', x: 160 - 5, y: (80 - 10) } }],
        'TWO': [
            { name: { baseline: 'top', x: 5, y: 5 }, value: { fontsize: 40, align: 'right', x: 160 - 5, y: 42 } },
            { name: { baseline: 'bottom', x: 5, y: (80 - 4) }, value: { fontsize: 24, align: 'right', x: 160 - 5, y: (80 - 8) } }
        ],
        'LR': [
            { name: { baseline: 'top', x: 5, y: 5 }, value: { fontsize: 40, align: 'left', x: 5, y: (80 - 10), } },
            { name: { align: 'right', baseline: 'top', x: 160 - 3, y: 4 }, value: { fontsize: 40, align: 'right', x: 160 - 5, y: (80 - 10) } }
        ],
        'BP': [
            { name: { baseline: 'top', x: 5, y: 5 }, value: { fontsize: 38, align: 'right', x: 160 - 5, y: 37 } },
            { value: { fontsize: 38, align: 'right', x: 160 - 5, y: (80 - 8) } }
        ],
        'VNT': [
            { name: { baseline: 'top', x: 5, y: 5 }, value: { fontsize: 38, align: 'right', x: 160 - 45, y: 37 } },
            { value: { fontsize: 30, align: 'right', x: 160 - 5, y: 37 } },
            { value: { fontsize: 24, align: 'right', x: 160 - 5, y: (80 - 8) } }
        ]
    }
};
